...
class _AddConsumptionPageState extends State<AddConsumptionPage> {
  ...
  List<Map<String, dynamic>> addedConsumptions = []; // eklenenleri tutacak
  ...
  void _startTimer() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (_) {
      setState(() {
        ...
        final autoAmount = timerSeconds * 0.2; // örnek: 1s = 0.2 L
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Eklenenler listesi
          if (addedConsumptions.isNotEmpty)
            Container(
              height: 200,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      title: Text(
                          "${item['category']} - ${item['amount'].toStringAsFixed(1)} L"),
                      trailing: IconButton(
