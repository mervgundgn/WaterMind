...
class AppDefaultValues {
  static const double defaultShowerConsumptionPerMinute = 10.0; // L/dk
  static const double defaultDrinkingWaterGoal = 2000.0; // ml/gün

  static double get defaultLaundryConsumption => 50.0; // L/makine
  static double get defaultDishesConsumption => 12.0;  // L/makine
